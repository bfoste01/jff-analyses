...
' 
# fit as continuous
fit.biFac.cont <- cfa(model.biFac, data=items, missing='fiml', std.lv=FALSE)
summary(fit.biFac.cont, fit.measures=TRUE)

# fit as ordered categorical 
fit.biFac.ordered <- cfa(model.biFac, data=items, missing='pairwise', std.lv=FALSE, ordered = names(items))
